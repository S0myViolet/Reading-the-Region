...
const NEW_THEMES: ClusterTheme[] = [
  {
    id: "CLU-104",
    name: "Wellness is moving from lifestyle preference to infrastructure layer",
    unifyingQuestion: "What happens when health stops being a product and becomes a place?",
    statement:
      "Clinics inside hotels, health metrics inside residences, recovery rooms inside offices and gyms inside mosque districts point one way: wellness is being poured into the built environment rather than sold as a service on top of it.",
    evidenceSummary:
      "Developer specifications, hospitality openings, employer benefits programmes and municipal design codes increasingly treat health capability as base-layer infrastructure.",
    contradictionId: null,
    recipes: [
      {
        title: "{city} developer specifies clinical-grade wellness floors in a residential launch",
        whatHappened: "A {city} developer announced a residential project whose specification includes diagnostic suites, circadian lighting and recovery amenities as standard floors rather than optional add-ons.",
        behaviour: "Buyers are beginning to evaluate homes on embedded health capability, not just location and finish.",
        system: "The housing system is absorbing functions that previously belonged to the healthcare system.",
        future: "Residential value may increasingly price in health infrastructure the way it once priced in parking or pools.",
        whyItMatters: "When health moves into the building specification, developers, insurers and operators start competing on a new axis of value.",
      ...
      {
        title: "Employers in {city} add recovery and longevity services to standard benefits",
        whatHappened: "Large employers in {city} extended standard benefits to include recovery services, sleep programmes and longevity diagnostics for mid-level staff.",
        behaviour: "Health optimisation is shifting from a private consumer purchase to an expected workplace provision.",
        system: "The labour system is taking on health-infrastructure roles as a talent-retention necessity.",
        future: "Employment offers in the Gulf may compete on embedded health capability as much as salary.",
        whyItMatters: "Benefits design is a leading edge of what becomes normal consumer expectation a few years later.",
  ...
  {
    id: "CLU-105",
    name: "Capital is treating the Gulf as a long-term confidence platform",
    unifyingQuestion: "What does capital believe about the Gulf when it stops asking for exit terms?",
    statement:
      "Family offices relocating, funds opening permanent regional headquarters, founders domiciling companies locally and long-dated infrastructure commitments suggest capital is repricing the Gulf from opportunistic market to structural base.",
    evidenceSummary:
      "Registration data, fund announcements, relocation reporting and banking commentary converge on longer commitment horizons.",
    contradictionId: null,
    recipes: [
      {
        title: "International fund opens a permanent {city} headquarters with regional mandate",
        whatHappened: "An international investment firm converted its {city} outpost into a permanent regional headquarters with local hiring targets and a long-dated mandate.",
        behaviour: "Capital allocators are moving from fly-in coverage to resident presence.",
        system: "The capital system is localising: decision rights, not just money, are moving to the region.",
        future: "The Gulf may become a place where regional strategies are authored rather than approved remotely.",
        whyItMatters: "Where decision rights sit determines which region's assumptions shape allocation.",
      ...
      {
        title: "Founders in {city} domicile new ventures locally instead of offshore",
        whatHappened: "Startup registrations in {city} show founders choosing local domicile and regional cap tables where offshore structures were previously default.",
        behaviour: "Builders are betting their corporate lives on regional jurisdiction, not just their offices.",
        system: "The governance system is earning a trust it previously had to borrow from offshore centres.",
        future: "A generation of regional companies may grow up legally and culturally native to the Gulf.",
        whyItMatters: "Domicile choices are among the least reversible confidence votes an economy receives.",
  ...
  {
    id: "CLU-106",
    name: "Regional cultural production is replacing imported legitimacy",
    unifyingQuestion: "When does the region stop importing its mirrors?",
    statement:
      "Commissioning budgets, prime-time slots, museum programmes and brand campaigns are moving from licensing global culture toward producing regional culture — and audiences are rewarding the shift.",
    evidenceSummary:
      "Programming decisions, chart data, casting choices and institutional acquisitions all point toward locally authored work carrying the prestige that imports once held.",
    contradictionId: null,
    recipes: [
      {
        title: "Prime-time slate in {country} commissions original regional drama over licensed formats",
        whatHappened: "A major broadcaster in {country} announced a season slate weighted toward original regional drama and documentary over licensed international formats.",
        behaviour: "Audiences are choosing stories set in their own cities in their own dialects.",
        system: "The cultural production system is moving from import-and-adapt to author-and-export.",
        future: "The region may become a net exporter of narrative about itself.",
        whyItMatters: "Whoever authors the narrative sets the reference points for aspiration and identity.",
      ...
      {
        title: "{city} museum acquires living regional designers into its permanent collection",
        whatHappened: "A {city} cultural institution moved works by living regional designers into its permanent collection, alongside — not beneath — international holdings.",
        behaviour: "Institutions are conferring canonical status on contemporary regional authorship.",
        system: "The identity system is acquiring institutional infrastructure for self-definition.",
        future: "Regional design languages may become canon that global institutions later import.",
        whyItMatters: "Canonisation converts cultural moments into durable reference points and market value.",
  ...
  {
    id: "CLU-107",
    name: "Convenience is being challenged by demand for certainty and trust",
    unifyingQuestion: "What do consumers pay for when everything is instantly available?",
    statement:
      "Verification services, human review options, provenance labelling and slower-but-certain fulfilment tiers are growing precisely where instant convenience is most saturated — certainty is becoming the scarce good.",
    evidenceSummary:
      "Platform feature launches, complaint data, willingness-to-pay surveys and banking escalation volumes show demand shifting from speed to assurance.",
    contradictionId: null,
    recipes: [
      {
        title: "Platform in {country} launches a paid human-verified tier for high-stakes orders",
        whatHappened: "A consumer platform operating in {country} introduced a paid tier where high-stakes transactions are human-verified before completion.",
        behaviour: "Consumers accept slower service and higher cost in exchange for certainty in transactions that matter.",
        system: "The trust system is being productised as a premium layer on top of automated convenience.",
        future: "Verification may become a standard priced tier across categories the way expedited shipping once did.",
        whyItMatters: "Willingness to pay for certainty inverts a decade of speed-first product strategy.",
      ...
      {
        title: "Provenance labelling spreads across {city} food and craft retail",
        whatHappened: "Retailers across {city} adopted provenance labelling — named farms, named makers, verifiable origin — on food and craft goods.",
        behaviour: "Shoppers are choosing traceable origin over anonymous abundance.",
        system: "The consumption system is rebuilding the information layer that industrial supply chains stripped out.",
        future: "Verified origin may become the default expectation for premium goods regionally.",
        whyItMatters: "Provenance is a defensible margin in categories being commoditised by synthetic supply.",
  ...
  {
    id: "CLU-108",
    name: "Youth social life is rebuilding around active third places",
    unifyingQuestion: "Where does a generation go when it stops going to malls first?",
    statement:
      "Padel courts, run clubs, climbing gyms, specialty coffee and community sport leagues are becoming the default social architecture for Gulf youth — active, semi-public, membership-light and identity-rich.",
    evidenceSummary:
      "Venue openings, municipal bookings data, creator content volume and event calendars show sustained growth in active third places across Gulf cities.",
    contradictionId: null,
    recipes: [
      {
        title: "Community sport league in {city} outgrows its municipal venue allocation",
        whatHappened: "A community sport league in {city} exceeded its municipal venue allocation for the third consecutive season, with waiting lists across age groups.",
        behaviour: "Young residents are organising social life around recurring active commitments rather than occasional consumption outings.",
        system: "The community system is acquiring physical infrastructure outside malls and private compounds.",
        future: "Cities may plan for active third places as core social infrastructure, not leisure amenity.",
        whyItMatters: "Where a generation habitually gathers determines which brands, formats and institutions reach it.",
